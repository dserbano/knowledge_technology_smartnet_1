...
(defrule ask-a-questionnaire
   ...
   (bind ?accepted-replies (create$ -1 -0.8 -0.6 -0.4 0 0.4 0.6 0.8 1))
   (assert (a-fact (name ?the-fact) (cf (next-questionnaire ?the-questionnaire ?accepted-replies)))))
...
(defrule job-selection-rule-2
  ...
  (and
    ...
    (a-fact (name likes-studying) (cf ?cf3))
    (a-fact (name likes-teaching) (cf ?cf4)))
  =>
  (printout  t "Professor with cf " (* 0.7 (max ?cf1 ?cf2 ?cf3 ?cf4)) crlf)
  (printout  t crlf))
...
(defrule job-selection-rule-3
  ...
  =>
  (printout  t "HR Manager with cf " (* 0.9 (max ?cf1 ?cf2)) crlf)
  (printout  t crlf))
...
(defrule job-selection-rule-4
  ...
  =>
  (printout  t "Computer Programmer with cf " (* 0.8 (max ?cf1 ?cf2 ?cf3 ?cf4) )crlf)
  (printout  t crlf))
...
(defrule job-selection-rule-5
  ...
  (and
    ...
    (a-fact (name good-with-computers) (cf ?cf4)))
  =>
  (printout  t "Mathematician with cf " (* 0.7 (max ?cf1 ?cf2 ?cf3 ?cf4)) crlf)
  (printout  t crlf))
...
(defrule job-selection-rule-6
  ...
  =>
  (printout  t "Architect with cf " (* 0.8 (max ?cf1 ?cf2 ?cf3)) crlf)
  (printout  t crlf))
...
(defrule job-selection-rule-7
  ...
  (and
    ...
    (a-fact (name likes-teaching) (cf ?cf3)))
  =>
  (printout  t "Construction Worker with cf " (* 0.9 (max ?cf1 ?cf2 ?cf3)) crlf)
  (printout  t crlf))
